...
const fileItem = tv({
  slots: {
    ...
    icon: "rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50",
    deleteButton: "",
  },
      ...
      {state === "error" ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-xs font-medium text-error-700 dark:text-error-400">
              Upload faliled, please try again.
            </span>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-xs font-medium to-zinc-700 dark:text-zinc-100">
              {name}
            </span>
          ...
          <div className="flex w-full items-center gap-3">
            ...
            <span className="text-sm font-medium to-zinc-700 dark:text-zinc-300">
